...
function init_socket(args) {
	...
	$(".disconnected").hide();
	if (is_sdk && (Cookies.get("windows") || Cookies.get("local_ip") || window.location.host == "advanture.land" || window.location.host == "x.thegame.com" || window.location.host == "0.0.0.0")) server_addr = "0.0.0.0"; // Cookies.set('windows','1',{expires:12*365});
	else if (is_sdk) {
