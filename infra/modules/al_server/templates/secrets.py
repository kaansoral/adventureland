...
BOT_MASTER="${bot_key}" #this key lets bots identify themselves as bots [03/08/17]
SERVER_MASTER="${keyword}" #this key lets servers identify themselves as servers [03/08/17]
